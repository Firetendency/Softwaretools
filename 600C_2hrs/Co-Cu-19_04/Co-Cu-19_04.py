...
# The input image.
image = cv2.imread("Co-Cu-19_04.tif",0)
image=image[0:696, :]
...
#tophat=cv2.morphologyEx(dilated, cv2.MORPH_TOPHAT, kernel,iterations=1)
#cv2.imshow("original", image)
#cv2.imshow("tophat", tophat)
#cv2.waitKey(0)


#plt.hist(dilated, bins=100, range=(0,150))
...
viewer=ImageViewer(image_label_overlay)
viewer.show()
...
fig=sns.distplot(df.area_sq_microns)
plt.show()
