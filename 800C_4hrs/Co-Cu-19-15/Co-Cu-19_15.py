...
# The input image.
image = cv2.imread("Co-Cu-19_15.tif",0) # 0 for grey image 1 for color image
image=image[0:696, :]
scale = 0.1116 #microns/pixel
Pixelcut= 0 #Minimum pixel Size

#plt.hist(image.flat, bins=100, range=(0,255))  #.flat returns the flattened numpy array (1D)
...
df.to_csv('measurements-0pixdel.csv')
